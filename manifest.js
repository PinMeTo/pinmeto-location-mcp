...
const manifest = {
  ...
  documentation: 'https://github.com/PinMeTo/pinmeto-location-mcp',
  ...
  repository: {
    type: 'git',
    url: 'git+https://github.com/PinMeTo/pinmeto-location-mcp'
  },
  license: 'MIT',
  privacy_policies: ['https://places.pinmeto.com/listings/public/legal/privacypolicy']
};
